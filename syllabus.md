...
In order to receive full credit for work, students must turn in required deliverables on the specified due date. Late work will not be accepted unless you fall under the special circumstances (e.g., religious holidays, military duty, etc.). Read the link above under attendance. You are welcome, however, to submit work early.
